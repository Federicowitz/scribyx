...
import { ChevronRight, ChevronDown, Plus, Trash2, Edit3, PanelLeftClose, Wrench, FileDown, FileUp, Download, Share2, Cloud } from 'lucide-react';
...
function TodoSidebar({ todos, onAdd, onToggle, onRemove, onNavigate, readOnly = false }: any) {
        ...
        {open.map((t: Todo) => (
          <div key={t.id} className="todo-item">
            <input
              ...
              checked={false}
              disabled={readOnly}
              onChange={() => !readOnly && onToggle(t.id)}
            />
            <span
